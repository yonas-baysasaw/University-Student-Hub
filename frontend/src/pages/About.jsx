...
const features = [
  {
    ...
    description:
      'Track classes, updates, and resources from a single dashboard that works on desktop and mobile.',
  },
  {
    title: 'Secure and reliable',
    description:
      'Built around authenticated sessions so students can access information with confidence.',
  },
  {
    title: 'Designed for momentum',
    description:
      'Fast interactions, clear layouts, and smooth transitions help you stay focused throughout the day.',
  },
];
      ...
      <main className="mx-auto max-w-6xl space-y-7">
        <section className="panel-card fade-in-up rounded-3xl p-6 md:p-9">
          ...
          <p className="mt-4 max-w-3xl text-base text-slate-600 md:text-lg">
            Organize your student life, follow key updates, and work with less
            friction through an interface designed to feel fast and dependable.
          </p>
