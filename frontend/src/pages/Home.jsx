...
function Home() {
  ...
  return (
    <div className="dashboard-ambient page-surface min-h-[calc(100vh-5.5rem)] px-3 pb-8 pt-5 md:px-6 md:pb-14 md:pt-8">
      <div className="pointer-events-none absolute inset-x-0 top-0 z-0 h-[min(240px,32vh)] workspace-hero-mesh opacity-75 dark:opacity-55 sm:h-[min(280px,36vh)]" />

      <div className="relative z-[2] mx-auto max-w-6xl space-y-4 md:space-y-8">
        <section className="dashboard-card-lift relative overflow-hidden rounded-2xl border border-slate-200/90 bg-gradient-to-br from-white via-white to-cyan-50/50 p-4 shadow-[0_28px_70px_-28px_rgba(15,23,42,0.22)] dark:border-slate-600/80 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900/95 dark:shadow-[0_32px_80px_-28px_rgba(0,0,0,0.55)] sm:rounded-[1.75rem] sm:p-6 md:p-9">
          ...
          <div className="relative flex flex-col gap-5 sm:gap-8 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0 flex-1 space-y-3 sm:space-y-4">
              ...
              <div>
                <h1 className="font-display text-balance text-2xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-3xl md:text-[2.35rem] md:leading-[1.15]">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 pt-1">
                <Link
                  to="/classroom"
                  className="btn-primary inline-flex items-center gap-2 px-5 py-2 text-sm shadow-lg shadow-cyan-900/15 sm:px-6 sm:py-2.5"
                >
                  Go to classrooms
