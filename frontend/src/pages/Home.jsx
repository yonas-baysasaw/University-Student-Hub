...
const highlights = [
  {
    ...
    description:
      'Jump between sections quickly with a clean and responsive layout.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Consistent transitions and motion feedback improve usability.',
  },
];
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <section className="panel-card fade-in-up rounded-3xl p-6 md:p-8">
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-600 md:text-base">
            Stay on top of your priorities with quick notes, progress tracking,
            and faster access to account actions.
          </p>
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <a
              ...
              className="rounded-full px-2 py-2 text-sm font-semibold text-slate-500 transition hover:text-slate-800"
            >
              Sign out
            </a>
          </div>
        ...
        <section className="grid gap-4 lg:grid-cols-[1.35fr_1fr]">
          ...
          <article className="panel-card rounded-2xl p-5">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Saved in your browser for fast reminders.
            </p>
