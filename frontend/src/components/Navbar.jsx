...
function Navbar({ children }) {
  ...
  return (
    <div className="pb-8">
      {/* position: relative + z-50 so the dropdown stacks above main content */}
        ...
        <div className="glass-nav mx-auto flex w-full max-w-6xl flex-wrap items-center justify-between gap-3 rounded-2xl px-3 py-2 sm:px-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul className="menu menu-sm dropdown-content z-[9999] mt-3 w-64 rounded-2xl border border-slate-200 bg-white p-2 text-slate-700 shadow-xl">
                {/* Profile header */}
                <li>
      ...
      {byokOpen && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
          ...
          <div className="relative z-10 panel-card w-full max-w-md rounded-3xl p-6 shadow-2xl">
            ...
            {byokMsg && (
              <p
                className={`mb-3 text-xs font-medium ${byokMsg.startsWith('✓') || byokMsg === 'Saved!' || byokMsg === 'Cleared.' ? 'text-emerald-600' : 'text-rose-600'}`}
              >
                {byokMsg}
              </p>
            )}
