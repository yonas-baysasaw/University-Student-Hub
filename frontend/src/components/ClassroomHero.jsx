...
function ClassroomHero({ title, eyebrow, meta = null, actions = null }) {
  return (
    <div className="relative mb-3 overflow-hidden rounded-2xl border border-slate-200/90 bg-gradient-to-br from-white via-white to-cyan-50/35 px-4 py-3 shadow-[0_12px_40px_-18px_rgba(15,23,42,0.12)] dark:border-slate-700/90 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950/95 sm:px-5">
      <div
        className="pointer-events-none absolute -right-6 -top-10 h-28 w-28 rounded-full bg-gradient-to-br from-cyan-400/25 to-indigo-400/15 blur-2xl dark:from-cyan-500/15 dark:to-indigo-500/10"
        aria-hidden
      />
