    ...
    <div className="page-surface flex items-center justify-center px-3 py-6 md:px-6 md:py-10">
      <div className="panel-card fade-in-up w-full max-w-md rounded-2xl p-4 sm:rounded-3xl sm:p-8">
        <div className="text-center">
          <div className="mx-auto mb-2 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-700 to-slate-900 text-xs font-bold text-cyan-100 shadow-md sm:mb-3 sm:h-12 sm:w-12 sm:rounded-2xl sm:text-sm">
            USH
          </div>
